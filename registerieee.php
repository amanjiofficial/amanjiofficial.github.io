...
document.myForm.status.options.length = 0;
        ...
        case "workshop" :
            ...
            document.myForm.status.options[1]=new Option("TECHBLOCKS","techblocks");
            break;
        case "competition" :
            document.myForm.status.options[0]=new Option("Select status","");
            document.myForm.status.options[1]=new Option("CODE-A-THON","code-a-thon");
            document.myForm.status.options[2]=new Option("XENITH","xenith");
            break;
        }
        return true;
    }
